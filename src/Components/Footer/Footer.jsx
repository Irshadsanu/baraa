  ...
  return (
    <footer>
      <div className="top-footer">
        ...
        <ul className="service-footer">
          <h3>Services</h3>
          <Link to={"/service#visa-assistance"}>
            <li>Visa Assistance</li>
          </Link>
          <Link to={"/service#translation"}>
            <li>Translation</li>
          </Link>
          <Link to={"/service#new-business-setup"}>
            <li>New Business Setup</li>
          </Link>
          <Link to={"/service#legal-support"}>
            <li>Legal Support</li>
          </Link>
        </ul>
        <ul className="company">
          <h3>Company</h3>
          <Link to={"/about#visa-assistance"}>
            <li>About Us</li>
          </Link>
          <Link to={"/contact"}>
            <li>Contact Info</li>
